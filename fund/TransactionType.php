...
class TransactionType extends BaseModel {
    ...
    const TYPE_PLAT_TRANSFER_IN        = 31;
    const TYPE_PLAT_TRANSFER_OUT       = 32;
    const TYPE_DISCOUNT_CARD_TRANSFER_IN       = 33;
    const TYPE_DISCOUNT_CARD_TRANSFER_OUT       = 34;
    const TYPE_EVENT_PRIZE             = 35;
    const TYPES_JC_BONUS = 36; //竞彩嘉奖
    const TYPES_DELETE_EVENT_PRIZE = 37;
...
//        $this->withdrawable = $oFundFlow->withdrawable;
    ...
    private static function makeCacheKeyOfAll() {
        return Config::get('cache.prefix') . 'basic-transaction-types';
    }
