...
//            $data = array_fill(0,$iDataLength,'');
            $aYiLou = array_fill(0,$iDataLength,0);
//            pr($aYiLou);
//            exit;
...
//            unset($data['wn_number']);
            ...
            $oNumber = new KlsfNumber($sNumber);
...
//            pr($aYiLou);
//            exit;
            $aAllBalls = KlsfNumber::getAllDigitals();
//            pr($aAllBalls);
//            pr($aBalls);
...
//                for($k = 1;$k <= 12;$k++){
                    $iIndexOfYilou = $iBaseIndex + $iNumber - 1;
//                    $iIndexOfYilou2 = $aFbStart + $k - 1;
//                    if ($k == $iNumber){
                        $aYiLou[$iIndexOfYilou] = $aTotalYiLou[$iIndexOfYilou] = 0;
//                        $aYiLou[$iIndexOfYilou2] = $aTotalYiLou[$iIndexOfYilou2] = 0;
//                    }
//                    else{
//                        $aYiLou[$iIndexOfYilou]++;
//                        $aTotalYiLou[$iIndexOfYilou]++;
////                        $aTotalYiLou[$iIndexOfYilou2]++;
//                        $aYiLou[$iIndexOfYilou] = $aTotalYiLou[$iIndexOfYilou];
//                        $aYiLou[$iIndexOfYilou2] = $aTotalYiLou[$iIndexOfYilou2];
//                    }
//                }
//                pr($iIndexOfYilou);
//                $value = intval($value);
