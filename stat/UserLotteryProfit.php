 ...
 * @author white
 */
class UserLotteryProfit extends BaseModel {

    protected $table                         = 'user_lottery_profits';
    public static $resourceName              = 'UserLotteryProfit';
     ...
     * @return UserProfit
     */
    public static function getUserProfitObject($sDate, $iUserId, $iLotteryId) {
        ...
        if (!is_object($obj)) {
            ...
            $obj = self::getUserProfitObject($sDate, $iUserId, $iLotteryId);
        } else {
    ...
    public static function updateProfitData($sType, $sDate, $iLotteryId, $oUser, $fAmount) {
        ...
        $oProfit   = self::getUserProfitObject($sDate, $oUser->id, $iLotteryId);
